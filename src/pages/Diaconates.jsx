...
import muyiwa from '../assets/muyiwa.webp';
import faj from '../assets/faj.webp';
import oke from '../assets/oke.webp';
import alabi from '../assets/alabi.webp';
import Ilori from '../assets/ilori.webp';
import bake from '../assets/bake.webp';
import deacon from '../assets/deacon.webp';
  ...
  return (
    <>
      ...
      <div class='flex flex-col md:flex-row gap-6 pt-10  p-4 px-4 md:px-16'>
        <div class='md:w-1/2 bg-blue rounded-3xl'>
          <div class='relative'>
            <img src={alabi} alt=' 1' class='w-full h-auto' />
            <div class='absolute bottom-0 left-48 bg-white bg-opacity-50 text-black  p-4'>
        ...
        <div class='md:w-1/2 bg-blue rounded-3xl'>
          <div class='relative'>
            <img src={oke} alt=' 1' class='w-full h-auto' />
            <div class='absolute bottom-0 left-48 bg-white bg-opacity-50 text-black  p-4'>
      ...
      <div class='flex flex-col md:flex-row gap-6 pt-10  p-4 px-4 md:px-16'>
        <div class='md:w-1/2 bg-blue rounded-3xl'>
          <div class='relative'>
            <img src={bake} alt=' 1' class='w-full h-auto' />
            <div class='absolute bottom-0 left-48 bg-white bg-opacity-50 text-black  p-4'>
        ...
        <div class='md:w-1/2 bg-blue rounded-3xl mb-10'>
          <div class='relative'>
            <img src={Ilori} alt=' 1' class='w-full h-auto' />
            <div class='absolute bottom-0 left-48 bg-white bg-opacity-50 text-black  p-4'>
